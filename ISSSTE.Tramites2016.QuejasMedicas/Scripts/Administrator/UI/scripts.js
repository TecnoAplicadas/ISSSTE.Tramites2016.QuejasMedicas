...
function setStatusValues(status, statusName) {
    if (status == null || status == undefined) return;

    $("#status-dropdow li a").parent().parent().parent().find(".btn:first-child").html(' Mostrar ' + statusName + ' <span class="caret"></span>');
    $("#status-dropdow li a").parent().parent().parent().find(".btn:first-child").val(status);
}