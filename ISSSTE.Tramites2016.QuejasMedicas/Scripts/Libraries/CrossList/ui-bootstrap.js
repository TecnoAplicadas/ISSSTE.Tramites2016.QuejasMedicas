...
angular.module("ui.bootstrap",
    [
        ...
        "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.isClass", "ui.bootstrap.datepicker",
        "ui.bootstrap.position", "ui.bootstrap.datepickerPopup", "ui.bootstrap.debounce", "ui.bootstrap.dropdown",
            ...
            function($scope,
                            ...
                            function(value) {
                                if (value) {
                                    ...
                                    self[key] = datepickerConfig[key]
                                        ? dateParser.fromTimezone(new Date(datepickerConfig[key]),
                ...
                this.init = function(ngModelCtrl_) {
                    ...
                    if ($scope.datepickerOptions.initDate) {
                        self.activeDate =
                            dateParser.fromTimezone($scope.datepickerOptions.initDate, ngModelOptions.timezone) ||
                            new Date();
            ...
            "$scope", "$element", "dateFilter", function(scope, $element, dateFilter) {
                ...
                this.handleKeyDown = function(key, evt) {
                    ...
                    if (key === "left") {
                        ...
                        date =
                            Math.min(getDaysInMonth(this.activeDate.getFullYear(), this.activeDate.getMonth()), date);
                    } else if (key === "home") {
                        date = 1;
                    } else if (key === "end") {
...
angular.module("ui.bootstrap.dropdown", ["ui.bootstrap.position"])
    ...
    .controller("UibDropdownController",
        [
            ...
            "$uibPosition", "$document", "$compile", "$templateRequest", function($scope,
                $element,
                $attrs,
                $parse,
                dropdownConfig,
                ...
                return {
                    create: function(ctrl, $scope, $attrs) {
                        ...
                        ctrl.calculateTotalPages = function() {
                            var totalPages = ctrl.itemsPerPage < 1
                                ? 1
                            ...
                            compile: function(tElem, tAttrs) {
                                ...
                                return function link(scope, element, attrs, tooltipCtrl) {
                                    ...
                                    var positionTooltip = function() {
                                        ...
                                        if (!positionTimeout) {
                                            positionTimeout = $timeout(function() {
                                                    var ttPosition =
                                                        $position.positionElements(element,
                                                            tooltip,
                                                            ttScope.placement,
                                                            appendToBody);
                                                    tooltip.css(
                                                        { top: ttPosition.top + "px", left: ttPosition.left + "px" });
                                    ...
                                    function prepareTooltip() {
                                        ...
                                        ttScope.placement =
                                            angular.isDefined(attrs[prefix + "Placement"])
                    ...
                    link: function(scope, elm, attrs, tabsetCtrl, transclude) {
                        ...
                        if (angular.isUndefined(attrs.index)) {
                            if (tabsetCtrl.tabs && tabsetCtrl.tabs.length) {
                                scope.index =
                                    Math.max.apply(null, tabsetCtrl.tabs.map(function(t) { return t.index; })) + 1;
                            } else {
                                scope.index = 0;
                            }
                        }
...
angular.module("ui.bootstrap.timepicker", [])
    ...
    .controller("UibTimepickerController",
        [
            "$scope", "$element", "$attrs", "$parse", "$log", "$locale", "uibTimepickerConfig", function($scope,
                $element,
                $attrs,
                $parse,
                $log,
                ...
                return function(matchItem, query) {
                    ...
                    if (!isSanitizePresent) {
                        matchItem =
                            $sce
                            .trustAsHtml(
                                matchItem); // If $sanitize is not present we pack the string in a $sce object for the ng-bind-html directive
                    }
                    return matchItem;
                };
            }
