...
(function($) {
        ...
        $.each(holidays_def,
            function(key, name) {
                ...
                if (!failed) {
                    var days = [];
                    if (lastDay) {
                        for (var date = new Date(firstDay.getTime());
    ...
    Calendar.prototype._render = function() {
        ...
        if (getExtentedOption(this, "first_day") == 1) {
            data.months = [
                this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6,
                this.locale.d0
            ];
        } else {
            data.months = [
                this.locale.d0, this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5,
                this.locale.d6
            ];
        }
    ...
    Calendar.prototype._week = function(event) {
        ...
        $.each(this.getEventsBetween(start, end),
            function(k, event) {
    ...
    Calendar.prototype._month = function(month) {
        ...
        t.data_day = this.options.position.start.getFullYear() +
            "-" +
    ...
    Calendar.prototype._day = function(week, day) {
        ...
        if (day <= 0) {
            var daysinprevmonth = (new Date(this.options.position.start.getFullYear(),
                this.options.position.start.getMonth(),
                0)).getDate();
    ...
    Calendar.prototype.getTitle = function() {
        ...
        case "week":
            ...
            break;
        case "day":
            return this.locale.title_day.format(this.locale["d" + p.getDay()],
                p.getDate(),
    ...
    Calendar.prototype._loadEvents = function() {
        ...
        this.options.onBeforeEventsLoad.call(this,
            function() {
    ...
    Calendar.prototype._loadTemplate = function(name) {
        ...
        var self = this;
        $.ajax({
            url: this.options.tmpl_path + name.replace("-", "_"),
            dataType: "html",
            type: "GET",
            async: false,
    ...
    Calendar.prototype._update_modal = function() {
        ...
        $("a[data-event-id]", this.context).on("click",
            function(event) {
                ...
                var event = _.find(self.options.events,
                    function(event) {
                        return event.id == id;
                    });
                ...
                if (!modal.data("handled.bootstrap-calendar") ||
                    (modal.data("handled.bootstrap-calendar") && modal.data("handled.event-id") != event.id)) {
                    modal
                        .on("show.bs.modal",
                            function() {
                                ...
                                case "template":
                                    ...
                                    modal_body.html(
                                        self.options.templates["modal"]({ "event": event, "calendar": self }));
                                    break;
                                }
    ...
    Calendar.prototype._update_month = function() {
        ...
        $("a.event").mouseenter(function() {
            $('a[data-event-id="' + $(this).data("event-id") + '"]').closest(".cal-cell1")
    ...
    Calendar.prototype._update_month_year = function() {
        ...
        var downbox = $(document.createElement("div")).attr("id", "cal-day-tick")
            .html('<i class="icon-chevron-down glyphicon glyphicon-chevron-down"></i>');
    ...
    Calendar.prototype.getEventsBetween = function(start, end) {
        ...
        $.each(this.options.events,
            function() {
                if ((parseInt(this.start) < end || this.start == null) &&
                    (parseInt(this.end) >= start || this.end == null)) {
                    events.push(this);
                }
            });
        return events;
