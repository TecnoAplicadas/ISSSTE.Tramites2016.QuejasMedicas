$(document).ready(function() {
    ...
    test("reduce",
        function() {
            ...
            raises(function() { _.reduce([], function() {}); },
                TypeError,
    ...
    test("reduceRight",
        function() {
            ...
            raises(function() { _.reduceRight([], function() {}); },
                TypeError,
                "throws an error for empty arrays with no initial value");
    ...
    test("find",
        function() {
            ...
            strictEqual(_.find(array, function() { return false; }),
                void 0,
    ...
    test("reject",
        function() {
            ...
            var evens = _.reject([1, 2, 3, 4, 5, 6],
                function(num) {
                    equal(context, "obj");
                    return num % 2 != 0;
                },
    ...
    test("invoke w/ function reference",
        function() {
            var list = [[5, 1, 7], [3, 2, 1]];
    ...
    test("invoke when strings have a call method",
        function() {
    ...
    test("sortBy",
        function() {
            ...
            var actual = _.sortBy(collection,
                function(pair) {
                    return pair.x;
                });
