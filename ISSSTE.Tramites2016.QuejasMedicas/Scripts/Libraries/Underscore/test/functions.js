$(document).ready(function() {
    ...
    asyncTest("throttle repeatedly with results",
        6,
        function() {
            var counter = 0;
            var incr = function() { return ++counter; };
    ...
    asyncTest("throttle triggers trailing call when invoked repeatedly",
        2,
        function() {
            var counter = 0;
            var limit = 48;
    ...
    asyncTest("debounce asap recursively",
        2,
        function() {
            var counter = 0;
    ...
    test("wrap",
        function() {
            ...
            var backwards = _.wrap(greet,
                function(func, name) { return func(name) + " " + name.split("").reverse().join(""); });
