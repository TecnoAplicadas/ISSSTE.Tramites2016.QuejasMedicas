$(document).ready(function() {
    ...
    test("uniq",
        function() {
            ...
            equal(_.map(_.uniq(list, false, iterator), iterator).join(", "),
                "moe, curly, larry",
                "can find the unique values of an array using a custom iterator");

            equal(_.map(_.uniq(list, iterator), iterator).join(", "),
                "moe, curly, larry",
