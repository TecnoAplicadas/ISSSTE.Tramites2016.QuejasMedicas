$(document).ready(function() {
    ...
    test("isEqual",
        function() {
            ...
            ok(!_.isEqual(new String("Curly"), { toString: function() { return "Curly"; } }),
            ...
            ok(!_.isEqual(new Number(75), new Number(63)),
                "Number objects with different primitive values are not equal");
            ok(!_.isEqual(new Number(63), { valueOf: function() { return 63; } }),
            ...
            ok(_.isEqual(true, new Boolean(true)),
            ...
            ok(!_.isEqual(new Boolean(true), new Boolean),
            ...
            ok(!_.isEqual(new Boolean(false), new Number(0)),
                "Boolean and number objects with like values are not equal");
            ok(!_.isEqual(false, new String("")),
            ...
            var a = [
                new Number(47), false, "Larry", /Moe/, new Date(2009, 11, 13),
            ...
            a.forEach = a.map = a.filter = a.every = a.indexOf = a.lastIndexOf = a.some = a.reduce = a.reduceRight =
                null;
    ...
    test("tap",
        function() {
            ...
            returned = _([1, 2, 3]).chain().map(function(n) { return n * 2; }).max().tap(interceptor).value();
