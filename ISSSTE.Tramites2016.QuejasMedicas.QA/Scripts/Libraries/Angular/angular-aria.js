            ...
            [
                "$aria", function($aria) {
                    ...
                    return {
                        ...
                        require: "?ngModel",
                        priority:
                            200, //Make sure watches are fired after any other directives that affect the ngModel value
                        compile: function(elem, attr) {
                            ...
                            return {
                                ...
                                post: function(scope, elem, attr, ngModel) {
                                    ...
                                    case "checkbox":
                                        ...
                                        if (shouldAttachAttr("aria-checked", "ariaChecked", elem)) {
                                            scope.$watch(ngAriaWatchModelValue,
                                                shape === "radio" ? getRadioReaction() : ngAriaCheckboxReaction);
                                        }
                                        break;
                                    case "range":
                                        if (shouldAttachRole(shape, elem)) {
                                    ...
                                    if (ngModel.$validators.required &&
