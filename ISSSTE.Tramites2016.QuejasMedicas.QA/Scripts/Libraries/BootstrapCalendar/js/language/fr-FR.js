...
window.calendar_languages["fr-FR"] = {
    ...
    error_where:
        'Calendrier: Mauvaise commande de navigation {0}. Commandes acceptées : "suivant", "précédent" or "aujourd\'hui"',
    error_timedevide:
        "Calendrier: paramètre pour le séparateur de temps doit diviser 60 par un nombre entier. Par exemple 10, 15, 30",
